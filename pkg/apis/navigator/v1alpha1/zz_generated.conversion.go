...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_CassandraImage_To_navigator_CassandraImage,
		Convert_navigator_CassandraImage_To_v1alpha1_CassandraImage,
...
func autoConvert_v1alpha1_CassandraImage_To_navigator_CassandraImage(in *CassandraImage, out *navigator.CassandraImage, s conversion.Scope) error {
...
// Convert_v1alpha1_CassandraImage_To_navigator_CassandraImage is an autogenerated conversion function.
func Convert_v1alpha1_CassandraImage_To_navigator_CassandraImage(in *CassandraImage, out *navigator.CassandraImage, s conversion.Scope) error {
	return autoConvert_v1alpha1_CassandraImage_To_navigator_CassandraImage(in, out, s)
}

func autoConvert_navigator_CassandraImage_To_v1alpha1_CassandraImage(in *navigator.CassandraImage, out *CassandraImage, s conversion.Scope) error {
...
// Convert_navigator_CassandraImage_To_v1alpha1_CassandraImage is an autogenerated conversion function.
func Convert_navigator_CassandraImage_To_v1alpha1_CassandraImage(in *navigator.CassandraImage, out *CassandraImage, s conversion.Scope) error {
	return autoConvert_navigator_CassandraImage_To_v1alpha1_CassandraImage(in, out, s)
}
