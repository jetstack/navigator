...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_PilotCassandraSpec_To_navigator_PilotCassandraSpec,
		Convert_navigator_PilotCassandraSpec_To_v1alpha1_PilotCassandraSpec,
...
func autoConvert_v1alpha1_PilotCassandraSpec_To_navigator_PilotCassandraSpec(in *PilotCassandraSpec, out *navigator.PilotCassandraSpec, s conversion.Scope) error {
	out.Decommissioned = in.Decommissioned
	return nil
}

// Convert_v1alpha1_PilotCassandraSpec_To_navigator_PilotCassandraSpec is an autogenerated conversion function.
func Convert_v1alpha1_PilotCassandraSpec_To_navigator_PilotCassandraSpec(in *PilotCassandraSpec, out *navigator.PilotCassandraSpec, s conversion.Scope) error {
	return autoConvert_v1alpha1_PilotCassandraSpec_To_navigator_PilotCassandraSpec(in, out, s)
}

func autoConvert_navigator_PilotCassandraSpec_To_v1alpha1_PilotCassandraSpec(in *navigator.PilotCassandraSpec, out *PilotCassandraSpec, s conversion.Scope) error {
	out.Decommissioned = in.Decommissioned
	return nil
}

// Convert_navigator_PilotCassandraSpec_To_v1alpha1_PilotCassandraSpec is an autogenerated conversion function.
func Convert_navigator_PilotCassandraSpec_To_v1alpha1_PilotCassandraSpec(in *navigator.PilotCassandraSpec, out *PilotCassandraSpec, s conversion.Scope) error {
	return autoConvert_navigator_PilotCassandraSpec_To_v1alpha1_PilotCassandraSpec(in, out, s)
}
...
func autoConvert_v1alpha1_PilotSpec_To_navigator_PilotSpec(in *PilotSpec, out *navigator.PilotSpec, s conversion.Scope) error {
	...
	out.Cassandra = (*navigator.PilotCassandraSpec)(unsafe.Pointer(in.Cassandra))
	return nil
}
...
func autoConvert_navigator_PilotSpec_To_v1alpha1_PilotSpec(in *navigator.PilotSpec, out *PilotSpec, s conversion.Scope) error {
	...
	out.Cassandra = (*PilotCassandraSpec)(unsafe.Pointer(in.Cassandra))
	return nil
}
