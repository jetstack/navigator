...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_CassandraClusterPersistenceConfig_To_navigator_CassandraClusterPersistenceConfig,
		Convert_navigator_CassandraClusterPersistenceConfig_To_v1alpha1_CassandraClusterPersistenceConfig,
...
func autoConvert_v1alpha1_CassandraClusterNodePool_To_navigator_CassandraClusterNodePool(in *CassandraClusterNodePool, out *navigator.CassandraClusterNodePool, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_CassandraClusterPersistenceConfig_To_navigator_CassandraClusterPersistenceConfig(&in.Persistence, &out.Persistence, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_navigator_CassandraClusterNodePool_To_v1alpha1_CassandraClusterNodePool(in *navigator.CassandraClusterNodePool, out *CassandraClusterNodePool, s conversion.Scope) error {
	out.Name = in.Name
	out.Replicas = in.Replicas
	if err := Convert_navigator_CassandraClusterPersistenceConfig_To_v1alpha1_CassandraClusterPersistenceConfig(&in.Persistence, &out.Persistence, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_CassandraClusterPersistenceConfig_To_navigator_CassandraClusterPersistenceConfig(in *CassandraClusterPersistenceConfig, out *navigator.CassandraClusterPersistenceConfig, s conversion.Scope) error {
	out.Size = in.Size
	out.StorageClass = in.StorageClass
	return nil
}

// Convert_v1alpha1_CassandraClusterPersistenceConfig_To_navigator_CassandraClusterPersistenceConfig is an autogenerated conversion function.
func Convert_v1alpha1_CassandraClusterPersistenceConfig_To_navigator_CassandraClusterPersistenceConfig(in *CassandraClusterPersistenceConfig, out *navigator.CassandraClusterPersistenceConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_CassandraClusterPersistenceConfig_To_navigator_CassandraClusterPersistenceConfig(in, out, s)
}

func autoConvert_navigator_CassandraClusterPersistenceConfig_To_v1alpha1_CassandraClusterPersistenceConfig(in *navigator.CassandraClusterPersistenceConfig, out *CassandraClusterPersistenceConfig, s conversion.Scope) error {
	out.Size = in.Size
	out.StorageClass = in.StorageClass
	return nil
}

// Convert_navigator_CassandraClusterPersistenceConfig_To_v1alpha1_CassandraClusterPersistenceConfig is an autogenerated conversion function.
func Convert_navigator_CassandraClusterPersistenceConfig_To_v1alpha1_CassandraClusterPersistenceConfig(in *navigator.CassandraClusterPersistenceConfig, out *CassandraClusterPersistenceConfig, s conversion.Scope) error {
	return autoConvert_navigator_CassandraClusterPersistenceConfig_To_v1alpha1_CassandraClusterPersistenceConfig(in, out, s)
}
