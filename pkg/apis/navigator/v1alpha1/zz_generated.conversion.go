...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_FailureZone_To_navigator_FailureZone,
		Convert_navigator_FailureZone_To_v1alpha1_FailureZone,
		Convert_v1alpha1_FailureZoneConfig_To_navigator_FailureZoneConfig,
		Convert_navigator_FailureZoneConfig_To_v1alpha1_FailureZoneConfig,
		Convert_v1alpha1_FailureZoneSource_To_navigator_FailureZoneSource,
		Convert_navigator_FailureZoneSource_To_v1alpha1_FailureZoneSource,
...
func autoConvert_v1alpha1_CassandraClusterNodePool_To_navigator_CassandraClusterNodePool(in *CassandraClusterNodePool, out *navigator.CassandraClusterNodePool, s conversion.Scope) error {
	...
	out.FailureZones = (*navigator.FailureZoneConfig)(unsafe.Pointer(in.FailureZones))
	return nil
}
...
func autoConvert_navigator_CassandraClusterNodePool_To_v1alpha1_CassandraClusterNodePool(in *navigator.CassandraClusterNodePool, out *CassandraClusterNodePool, s conversion.Scope) error {
	...
	out.FailureZones = (*FailureZoneConfig)(unsafe.Pointer(in.FailureZones))
	return nil
}
...
func autoConvert_v1alpha1_FailureZone_To_navigator_FailureZone(in *FailureZone, out *navigator.FailureZone, s conversion.Scope) error {
	out.Value = in.Value
	out.ValueFrom = (*navigator.FailureZoneSource)(unsafe.Pointer(in.ValueFrom))
	return nil
}

// Convert_v1alpha1_FailureZone_To_navigator_FailureZone is an autogenerated conversion function.
func Convert_v1alpha1_FailureZone_To_navigator_FailureZone(in *FailureZone, out *navigator.FailureZone, s conversion.Scope) error {
	return autoConvert_v1alpha1_FailureZone_To_navigator_FailureZone(in, out, s)
}

func autoConvert_navigator_FailureZone_To_v1alpha1_FailureZone(in *navigator.FailureZone, out *FailureZone, s conversion.Scope) error {
	out.Value = in.Value
	out.ValueFrom = (*FailureZoneSource)(unsafe.Pointer(in.ValueFrom))
	return nil
}

// Convert_navigator_FailureZone_To_v1alpha1_FailureZone is an autogenerated conversion function.
func Convert_navigator_FailureZone_To_v1alpha1_FailureZone(in *navigator.FailureZone, out *FailureZone, s conversion.Scope) error {
	return autoConvert_navigator_FailureZone_To_v1alpha1_FailureZone(in, out, s)
}

func autoConvert_v1alpha1_FailureZoneConfig_To_navigator_FailureZoneConfig(in *FailureZoneConfig, out *navigator.FailureZoneConfig, s conversion.Scope) error {
	out.Datacenter = (*navigator.FailureZone)(unsafe.Pointer(in.Datacenter))
	out.Rack = (*navigator.FailureZone)(unsafe.Pointer(in.Rack))
	return nil
}

// Convert_v1alpha1_FailureZoneConfig_To_navigator_FailureZoneConfig is an autogenerated conversion function.
func Convert_v1alpha1_FailureZoneConfig_To_navigator_FailureZoneConfig(in *FailureZoneConfig, out *navigator.FailureZoneConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_FailureZoneConfig_To_navigator_FailureZoneConfig(in, out, s)
}

func autoConvert_navigator_FailureZoneConfig_To_v1alpha1_FailureZoneConfig(in *navigator.FailureZoneConfig, out *FailureZoneConfig, s conversion.Scope) error {
	out.Datacenter = (*FailureZone)(unsafe.Pointer(in.Datacenter))
	out.Rack = (*FailureZone)(unsafe.Pointer(in.Rack))
	return nil
}

// Convert_navigator_FailureZoneConfig_To_v1alpha1_FailureZoneConfig is an autogenerated conversion function.
func Convert_navigator_FailureZoneConfig_To_v1alpha1_FailureZoneConfig(in *navigator.FailureZoneConfig, out *FailureZoneConfig, s conversion.Scope) error {
	return autoConvert_navigator_FailureZoneConfig_To_v1alpha1_FailureZoneConfig(in, out, s)
}

func autoConvert_v1alpha1_FailureZoneSource_To_navigator_FailureZoneSource(in *FailureZoneSource, out *navigator.FailureZoneSource, s conversion.Scope) error {
	out.NodeLabel = in.NodeLabel
	return nil
}

// Convert_v1alpha1_FailureZoneSource_To_navigator_FailureZoneSource is an autogenerated conversion function.
func Convert_v1alpha1_FailureZoneSource_To_navigator_FailureZoneSource(in *FailureZoneSource, out *navigator.FailureZoneSource, s conversion.Scope) error {
	return autoConvert_v1alpha1_FailureZoneSource_To_navigator_FailureZoneSource(in, out, s)
}

func autoConvert_navigator_FailureZoneSource_To_v1alpha1_FailureZoneSource(in *navigator.FailureZoneSource, out *FailureZoneSource, s conversion.Scope) error {
	out.NodeLabel = in.NodeLabel
	return nil
}

// Convert_navigator_FailureZoneSource_To_v1alpha1_FailureZoneSource is an autogenerated conversion function.
func Convert_navigator_FailureZoneSource_To_v1alpha1_FailureZoneSource(in *navigator.FailureZoneSource, out *FailureZoneSource, s conversion.Scope) error {
	return autoConvert_navigator_FailureZoneSource_To_v1alpha1_FailureZoneSource(in, out, s)
}
