...
func (in *CassandraClusterStatus) DeepCopyInto(out *CassandraClusterStatus) {
	*out = *in
	in.NavigatorClusterStatus.DeepCopyInto(&out.NavigatorClusterStatus)
	if in.NodePools != nil {
		in, out := &in.NodePools, &out.NodePools
...
func (in *ElasticsearchClusterSpec) DeepCopyInto(out *ElasticsearchClusterSpec) {
	*out = *in
	...
	if in.MinimumMasters != nil {
		in, out := &in.MinimumMasters, &out.MinimumMasters
		if *in == nil {
			*out = nil
		} else {
			*out = new(int32)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NavigatorClusterStatus) DeepCopyInto(out *NavigatorClusterStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NavigatorClusterStatus.
func (in *NavigatorClusterStatus) DeepCopy() *NavigatorClusterStatus {
	if in == nil {
		return nil
	}
	out := new(NavigatorClusterStatus)
	in.DeepCopyInto(out)
	return out
}
