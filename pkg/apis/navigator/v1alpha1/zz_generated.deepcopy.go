...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PilotCassandraSpec) DeepCopyInto(out *PilotCassandraSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PilotCassandraSpec.
func (in *PilotCassandraSpec) DeepCopy() *PilotCassandraSpec {
	if in == nil {
		return nil
	}
	out := new(PilotCassandraSpec)
	in.DeepCopyInto(out)
	return out
}
