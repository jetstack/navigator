...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraCluster": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "CassandraCluster describes a specification for an Cassandra cluster",
					Properties: map[string]spec.Schema{
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraClusterSpec"),
							},
						},
						"status": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraClusterStatus"),
							},
						},
					},
			...
			Dependencies: []string{
				"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraClusterSpec", "github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraClusterStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
		},
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraClusterList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "CassandraClusterList defines a List type for our custom CassandraCluster type. This is needed in order to make List operations work.",
					Properties: map[string]spec.Schema{
						"kind": {
							SchemaProps: spec.SchemaProps{
								Description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds",
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraCluster"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraCluster", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
		},
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraClusterNodePool": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "CassandraClusterNodePool describes a node pool within a CassandraCluster.",
					Properties: map[string]spec.Schema{
						"name": {
							SchemaProps: spec.SchemaProps{
								Type:   []string{"string"},
		...
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraClusterNodePoolStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"readyReplicas": {
		...
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraClusterSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"sysctl": {
						...
						"nodePools": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraClusterNodePool"),
										},
									},
								},
							},
						...
						"image": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ImageSpec"),
							},
						},
						"pilotImage": {
							SchemaProps: spec.SchemaProps{
					...
					Required: []string{"sysctl", "nodePools", "image", "pilotImage", "cqlPort"},
				},
			},
			Dependencies: []string{
				"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraClusterNodePool", "github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ImageSpec"},
		},
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraClusterStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"nodePools": {
							SchemaProps: spec.SchemaProps{
								...
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraClusterNodePoolStatus"),
										},
									},
								},
							},
					...
					Required: []string{"nodePools"},
				},
			},
			Dependencies: []string{
				"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.CassandraClusterNodePoolStatus"},
		},
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchCluster": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ElasticsearchCluster describes a specification for an Elasticsearch cluster",
					Properties: map[string]spec.Schema{
						"kind": {
							SchemaProps: spec.SchemaProps{
								Description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds",
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchClusterSpec"),
							},
						},
						"status": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchClusterStatus"),
							},
						},
					},
					Required: []string{"metadata", "spec", "status"},
		...
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchClusterList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ElasticsearchClusterList defines a List type for our custom ElasticsearchCluster type. This is needed in order to make List operations work.",
					Properties: map[string]spec.Schema{
						"kind": {
							SchemaProps: spec.SchemaProps{
								Description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds",
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchCluster"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchCluster", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
		},
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchClusterNodePool": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ElasticsearchClusterNodePool describes a node pool within an ElasticsearchCluster. The nodes in this pool will be configured to be of the specified roles",
					Properties: map[string]spec.Schema{
						"name": {
							SchemaProps: spec.SchemaProps{
						...
						"replicas": {
							SchemaProps: spec.SchemaProps{
								Description: "Number of replicas in the pool.",
								Type:        []string{"integer"},
								Format:      "int64",
							},
						},
						"roles": {
							SchemaProps: spec.SchemaProps{
								Description: "Roles that nodes in this pool should perform within the cluster.",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
						...
						"nodeSelector": {
							SchemaProps: spec.SchemaProps{
								Description: "NodeSelector should be specified to force nodes in this pool to run on nodes matching the given selector.",
								Type:        []string{"object"},
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
						...
						"resources": {
							SchemaProps: spec.SchemaProps{
								Description: "Resources specifies the resource requirements to be used for nodes that are part of the pool.",
								Ref:         ref("k8s.io/api/core/v1.ResourceRequirements"),
							},
						},
						"persistence": {
							SchemaProps: spec.SchemaProps{
								Description: "Persistence specifies the configuration for persistent data for this node. Disabling persistence can cause issues when nodes restart, so should only be using for testing purposes.",
								Ref:         ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchClusterPersistenceConfig"),
							},
						},
						"config": {
							SchemaProps: spec.SchemaProps{
								Description: "Config is a map of configuration files to be placed in the elasticsearch config directory. Environment variables may be used in these files and they will be automatically expanded by the Elasticsearch process.",
								Type:        []string{"object"},
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
					...
					Required: []string{"name", "replicas", "roles", "nodeSelector", "config"},
				},
			},
			Dependencies: []string{
				"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchClusterPersistenceConfig", "k8s.io/api/core/v1.ResourceRequirements"},
		},
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchClusterNodePoolStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ElasticsearchClusterNodePoolStatus specifies the status of a single node pool in an ElasticsearchCluster",
					Properties: map[string]spec.Schema{
						"readyReplicas": {
							SchemaProps: spec.SchemaProps{
								Description: "ReadyReplicas is the total number of ready pods in this cluster.",
								Type:        []string{"integer"},
								Format:      "int64",
							},
						},
		...
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchClusterPersistenceConfig": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ElasticsearchClusterPersistenceConfig contains persistent volume configuration.",
					Properties: map[string]spec.Schema{
						"enabled": {
							SchemaProps: spec.SchemaProps{
								Description: "Toggle whether persistence should be enabled on this cluster. If false, an emptyDir will be provisioned to store Elasticsearch data.",
								Type:        []string{"boolean"},
								Format:      "",
							},
						},
						"size": {
							SchemaProps: spec.SchemaProps{
								Description: "Size of the persistent volume to provision (required if persistence is enabled).",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"storageClass": {
							SchemaProps: spec.SchemaProps{
								Description: "StorageClass to use for the persistent volume claim. If not set, the default cluster storage class will be used.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
					},
					Required: []string{"enabled", "size", "storageClass"},
				},
			},
			Dependencies: []string{},
		},
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchClusterSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ElasticsearchClusterSpec describes a specification for an ElasticsearchCluster",
					Properties: map[string]spec.Schema{
						"plugins": {
							SchemaProps: spec.SchemaProps{
								Description: "A list of plugins to install on nodes in the cluster.",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
						...
						"nodePools": {
							SchemaProps: spec.SchemaProps{
								Description: "NodePools specify the various pools of nodes that make up this cluster. There must be at least one master node specified.",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchClusterNodePool"),
										},
									},
								},
							},
						...
						"pilot": {
							SchemaProps: spec.SchemaProps{
								Description: "Pilot describes the image containing the pilot-elasticsearch binary to run",
								Ref:         ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchPilotImage"),
							},
						},
						"image": {
							SchemaProps: spec.SchemaProps{
								Description: "Image describes the Elasticsearch image to use",
								Ref:         ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchImage"),
							},
						},
						"sysctl": {
							SchemaProps: spec.SchemaProps{
								Description: "Sysctl can be used to specify a list of sysctl values to set on start-up This can be used to set for example the vm.max_map_count parameter.",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
					...
					Required: []string{"plugins", "nodePools", "pilot", "image", "sysctl"},
				},
			},
			Dependencies: []string{
				"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchClusterNodePool", "github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchImage", "github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchPilotImage"},
		},
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchClusterStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ElasticsearchClusterStatus specifies the overall status of an ElasticsearchCluster.",
					Properties: map[string]spec.Schema{
						"nodePools": {
							SchemaProps: spec.SchemaProps{
								Type: []string{"object"},
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchClusterNodePoolStatus"),
										},
									},
								},
							},
		...
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchImage": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"repository": {
							SchemaProps: spec.SchemaProps{
								Description: "Repository is the repository of a docker image (e.g. 'alpine').",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"tag": {
							SchemaProps: spec.SchemaProps{
								Description: "Tag is the tag of a docker image (e.g. 'latest').",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"pullPolicy": {
							SchemaProps: spec.SchemaProps{
								Description: "PullPolicy is the policy for pulling docker images. If not set, the cluster default will be used.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"fsGroup": {
							SchemaProps: spec.SchemaProps{
								Description: "FsGroup specifies the user that the should be set for the pods fsGroup",
								Type:        []string{"integer"},
								Format:      "int64",
							},
						},
					},
					Required: []string{"repository", "tag", "pullPolicy", "fsGroup"},
				},
			},
			Dependencies: []string{},
		},
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchPilotImage": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"repository": {
		...
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchPilotStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"documents": {
							SchemaProps: spec.SchemaProps{
								Description: "Documents is the current number of documents on this node. nil indicates an unknown number of documents, whereas 0 indicates that the node is empty",
								Type:        []string{"integer"},
								Format:      "int64",
							},
						},
		...
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ImageSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ImageSpec specifies a docker image to be used.",
					Properties: map[string]spec.Schema{
						"repository": {
							SchemaProps: spec.SchemaProps{
								Description: "Repository is the repository of a docker image (e.g. 'alpine').",
		...
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.Pilot": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"kind": {
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.PilotSpec"),
							},
						},
						"status": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.PilotStatus"),
							},
						},
					},
					Required: []string{"metadata", "spec", "status"},
			...
			Dependencies: []string{
				"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.PilotSpec", "github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.PilotStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
		},
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.PilotCondition": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "PilotCondition contains condition information for a Pilot.",
					Properties: map[string]spec.Schema{
						"type": {
							SchemaProps: spec.SchemaProps{
		...
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.PilotElasticsearchSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{},
				},
		...
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.PilotList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"kind": {
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.Pilot"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.Pilot", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
		},
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.PilotSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"elasticsearch": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.PilotElasticsearchSpec"),
							},
						},
					},
		...
		"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.PilotStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"lastCompletedPhase": {
						...
						"conditions": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.PilotCondition"),
										},
									},
								},
							},
						...
						"elasticsearch": {
							SchemaProps: spec.SchemaProps{
								Description: "Contains status information specific to Elasticsearch Pilots",
								Ref:         ref("github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchPilotStatus"),
							},
						},
					},
					Required: []string{"lastCompletedPhase", "conditions"},
				},
			},
			Dependencies: []string{
				"github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.ElasticsearchPilotStatus", "github.com/jetstack/navigator/pkg/apis/navigator/v1alpha1.PilotCondition"},
		},
