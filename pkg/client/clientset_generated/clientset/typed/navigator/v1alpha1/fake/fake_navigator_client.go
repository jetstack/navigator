...
import (
	v1alpha1 "github.com/jetstack-experimental/navigator/pkg/client/clientset_generated/clientset/typed/navigator/v1alpha1"
...
func (c *FakeNavigatorV1alpha1) CouchbaseClusters(namespace string) v1alpha1.CouchbaseClusterInterface {
