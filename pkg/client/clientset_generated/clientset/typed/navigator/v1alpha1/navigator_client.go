...
func NewForConfig(c *rest.Config) (*NavigatorV1alpha1Client, error) {
	config := *c
	...
	return &NavigatorV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new NavigatorV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *NavigatorV1alpha1Client {
...
// New creates a new NavigatorV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *NavigatorV1alpha1Client {
	return &NavigatorV1alpha1Client{c}
}
...
func (c *NavigatorV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
