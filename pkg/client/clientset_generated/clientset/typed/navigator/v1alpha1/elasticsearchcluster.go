...
type ElasticsearchClusterInterface interface {
	Create(*v1alpha1.ElasticsearchCluster) (*v1alpha1.ElasticsearchCluster, error)
	Update(*v1alpha1.ElasticsearchCluster) (*v1alpha1.ElasticsearchCluster, error)
	UpdateStatus(*v1alpha1.ElasticsearchCluster) (*v1alpha1.ElasticsearchCluster, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ElasticsearchCluster, error)
	List(opts v1.ListOptions) (*v1alpha1.ElasticsearchClusterList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ElasticsearchCluster, err error)
...
func newElasticsearchClusters(c *NavigatorV1alpha1Client, namespace string) *elasticsearchClusters {
...
func (c *elasticsearchClusters) Update(elasticsearchCluster *v1alpha1.ElasticsearchCluster) (result *v1alpha1.ElasticsearchCluster, err error) {
	result = &v1alpha1.ElasticsearchCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elasticsearchclusters").
...
func (c *elasticsearchClusters) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ElasticsearchCluster, err error) {
	result = &v1alpha1.ElasticsearchCluster{}
