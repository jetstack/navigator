...
type ElasticsearchClusterInterface interface {
	Create(*v1alpha2.ElasticsearchCluster) (*v1alpha2.ElasticsearchCluster, error)
	Update(*v1alpha2.ElasticsearchCluster) (*v1alpha2.ElasticsearchCluster, error)
	UpdateStatus(*v1alpha2.ElasticsearchCluster) (*v1alpha2.ElasticsearchCluster, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.ElasticsearchCluster, error)
	List(opts v1.ListOptions) (*v1alpha2.ElasticsearchClusterList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.ElasticsearchCluster, err error)
...
func newElasticsearchClusters(c *NavigatorV1alpha2Client, namespace string) *elasticsearchClusters {
...
func (c *elasticsearchClusters) Get(name string, options v1.GetOptions) (result *v1alpha2.ElasticsearchCluster, err error) {
	result = &v1alpha2.ElasticsearchCluster{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *elasticsearchClusters) List(opts v1.ListOptions) (result *v1alpha2.ElasticsearchClusterList, err error) {
	result = &v1alpha2.ElasticsearchClusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("elasticsearchclusters").
...
func (c *elasticsearchClusters) Create(elasticsearchCluster *v1alpha2.ElasticsearchCluster) (result *v1alpha2.ElasticsearchCluster, err error) {
	result = &v1alpha2.ElasticsearchCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("elasticsearchclusters").
...
func (c *elasticsearchClusters) Update(elasticsearchCluster *v1alpha2.ElasticsearchCluster) (result *v1alpha2.ElasticsearchCluster, err error) {
	result = &v1alpha2.ElasticsearchCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elasticsearchclusters").
...
func (c *elasticsearchClusters) UpdateStatus(elasticsearchCluster *v1alpha2.ElasticsearchCluster) (result *v1alpha2.ElasticsearchCluster, err error) {
	result = &v1alpha2.ElasticsearchCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elasticsearchclusters").
...
func (c *elasticsearchClusters) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.ElasticsearchCluster, err error) {
	result = &v1alpha2.ElasticsearchCluster{}
