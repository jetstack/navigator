...
import (
	navigator_v1alpha2 "github.com/jetstack-experimental/navigator/pkg/apis/navigator/v1alpha2"
	...
	v1alpha2 "github.com/jetstack-experimental/navigator/pkg/client/listers_generated/navigator/v1alpha2"
...
type ElasticsearchClusterInformer interface {
	...
	Lister() v1alpha2.ElasticsearchClusterLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.NavigatorV1alpha2().ElasticsearchClusters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.NavigatorV1alpha2().ElasticsearchClusters(namespace).Watch(options)
			},
		},
		&navigator_v1alpha2.ElasticsearchCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *elasticsearchClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&navigator_v1alpha2.ElasticsearchCluster{}, defaultElasticsearchClusterInformer)
}

func (f *elasticsearchClusterInformer) Lister() v1alpha2.ElasticsearchClusterLister {
	return v1alpha2.NewElasticsearchClusterLister(f.Informer().GetIndexer())
}
