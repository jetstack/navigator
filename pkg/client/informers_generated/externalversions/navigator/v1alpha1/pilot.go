...
func NewPilotInformer(client clientset.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&navigator_v1alpha1.Pilot{},
		resyncPeriod,
		indexers,
	)
}

func defaultPilotInformer(client clientset.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *pilotInformer) Lister() v1alpha1.PilotLister {
	return v1alpha1.NewPilotLister(f.Informer().GetIndexer())
}
