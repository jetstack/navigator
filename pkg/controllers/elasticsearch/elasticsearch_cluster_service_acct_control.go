...
type ElasticsearchClusterServiceAccountControl interface {
	CreateElasticsearchClusterServiceAccount(*v1.ElasticsearchCluster) error
	UpdateElasticsearchClusterServiceAccount(*v1.ElasticsearchCluster) error
	DeleteElasticsearchClusterServiceAccount(*v1.ElasticsearchCluster) error
}
...
func (e *defaultElasticsearchClusterServiceAccountControl) CreateElasticsearchClusterServiceAccount(c *v1.ElasticsearchCluster) (err error) {
...
func (e *defaultElasticsearchClusterServiceAccountControl) UpdateElasticsearchClusterServiceAccount(c *v1.ElasticsearchCluster) (err error) {
	svcAcct := clusterServiceAccount(c)
...
func (e *defaultElasticsearchClusterServiceAccountControl) DeleteElasticsearchClusterServiceAccount(c *v1.ElasticsearchCluster) error {
	svcAcct := clusterServiceAccount(c)
...
func (e *defaultElasticsearchClusterServiceAccountControl) recordEvent(verb string, cluster *v1.ElasticsearchCluster, svcAcct *apiv1.ServiceAccount, err error) {
	if err == nil {
