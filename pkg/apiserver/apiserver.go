...
import (
	...
	cassandraclusterstorage "github.com/jetstack/navigator/pkg/registry/navigator/cassandracluster"
...
func (c completedConfig) New() (*NavigatorServer, error) {
	...
	escStorage, escStatusStorage, err := esclusterstorage.NewREST(Scheme, c.GenericConfig.RESTOptionsGetter)
	if err != nil {
		return nil, err
	}
